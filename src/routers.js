...
// 教师用户
// 学生管理
const teacher_student_list = r => require.ensure([], () => r(require('./view/teacher/student/list.vue')), 'group-teacher');
const teacher_student_import = r => require.ensure([], () => r(require('./view/teacher/student/import.vue')), 'group-teacher');
// 实习管理
const teacher_intern_list = r => require.ensure([], () => r(require('./view/teacher/intern/list.vue')), 'group-teacher');
const teacher_intern_chart = r => require.ensure([], () => r(require('./view/teacher/intern/chart.vue')), 'group-teacher');
// 校企合作管理
...
// 短学期管理
const teacher_short_list = r => require.ensure([], () => r(require('./view/teacher/short/list.vue')), 'group-teacher');
// const teacher_short_list = r => require.ensure([], () => r(require('./view/teacher/short/list.vue')), 'group-teacher');
...
var routes = [
  ...
  {
    path: '/teacher/short/list',
    component: teacher_short_list
  }
];
